      ...
      <div className="card-extras">
        <div className="section1">
          <div className="section1-subsection">
            <EventIcon />{" "}
            <span className="section1-subsection-text">Fri, 12 Oct, 2018</span>
          </div>
          <div className="section1-subsection">
            <LocationOnOutlinedIcon />
            <span className="section1-subsection-text">Ahmedabad, India</span>
          </div>
          <div></div>
        </div>
      ...
      <div className="card-footer">
        ...
        <div className="footer-info-sub2">
          <div className="view-icon">
            <VisibilityIcon /> <span className="view-text">800 Views</span>
          </div>
          <div className="share">
